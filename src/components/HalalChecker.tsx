    ...
    <div className="w-full max-w-2xl mx-auto px-4">
      ...
      <div className="mt-4 flex items-center justify-center space-x-2">
        <Button
          ...
          className={useFallback ? "bg-amber-500 hover:bg-amber-600" : "border-amber-500 text-amber-500"}
        >
          {useFallback ? "Using Offline Mode" : "Switch to Offline Mode"}
        </Button>
      </div>
      
      {useFallback && (
        <Alert className="mt-4 bg-amber-500/20 border-amber-500/50 text-white">
          <AlertDescription>
